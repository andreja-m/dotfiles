...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.maximized("/home/doomguy/Downloads/ap.jpg", s, true)
    end
end
...
awful.spawn.with_shell("terminator -e arandr /home/doomguy/.screenlayout/main.sh")
awful.spawn.with_shell("terminator -e ranger")
awful.spawn.with_shell("terminator -e bashtop")
awful.spawn.with_shell("terminator")
awful.spawn.with_shell("terminator -e pipes.sh -t 3")
